...
WebUI.verifyElementVisible(findTestObject('Page_Andaz12/div_Reservations_text'))
...
WebUI.comment('Check if the chatbot respond after clicking "Find out more" button')

WebUI.click(findTestObject('Object Repository/Page_Andaz12/div_Find out more_1'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Page_Andaz12/div_Find out more'))
